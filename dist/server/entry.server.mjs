...
function RenderVariantGroup({ variantGroup, path, onPathChange, onSelect }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("h3", { className: "text-lg font-medium", children: [
      ...
      ((_b = getVariant(selected)) == null ? void 0 : _b.stock) && /* @__PURE__ */ jsxs("span", { className: "  text-primary rounded-full px-2", children: [
...
async function getStore(host) {
  if (_stores[host] && false)
    return _stores[host];
  const isFeeefShop = host.includes(".feeef.store") || host.includes(".feeef.net") || host.includes(".feeef.app") || host.includes(".khfif.shop") || host.includes(".lvh.me");
